...
class Benchmark:
    ...
    def get_change_points(self):
        with open(self.filename.replace(".json", ".txt")) as f:
            self.change_points = f.readlines()
...
#        for changepoint in benchmark.get_change_points()[i].split(','):
#            if changepoint.strip() == "": continue
#            axs[i].axvline(x=int(changepoint), color='r')
